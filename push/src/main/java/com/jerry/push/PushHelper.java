...
public class PushHelper {
    ...
    public void init(final Context context) {
        ...
        pushAgent.setResourcePackageName("com.jerry.voiceassistant");
        ...
        pushAgent.register(new UPushRegisterCallback() {
            ...
            public void onSuccess(String deviceToken) {
                ...
                registerCallBack.onRegisterSuccess(deviceToken);
//                //获取deviceToken可通过接口：
...
//                });
            ...
            public void onFailure(String errCode, String errDesc) {
                ...
                registerCallBack.onFail(errCode, errDesc);
            }
        });
    ...
    private void registerDeviceChannel(Context context) {
      ...
      //  MiPushRegistar.register(context, com.umeng.message.demo.helper.PushConstants.MI_ID, com.umeng.message.demo.helper.PushConstants.MI_KEY);
       // 华为，注意华为通道的初始化参数在minifest中配置
        HuaWeiRegister.register((Application) context.getApplicationContext());
        //魅族，填写您在魅族后台APP对应的app id和key
      //  MeizuRegister.register(context, com.umeng.message.demo.helper.PushConstants.MEI_ZU_ID, com.umeng.message.demo.helper.PushConstants.MEI_ZU_KEY);
        //OPPO，填写您在OPPO后台APP对应的app key和secret
     //   OppoRegister.register(context, com.umeng.message.demo.helper.PushConstants.OPPO_KEY, com.umeng.message.demo.helper.PushConstants.OPPO_SECRET);
    ...
    private void pushSetting(Context context) {
        ...
        UmengMessageHandler msgHandler = new UmengMessageHandler() {
            ...
            public void dealWithNotificationMessage(Context context, UMessage msg) {
                ...
                registerCallBack.dealWithNotificationMessage(context,msg);
            }

            //自定义通知样式，此方法可以修改通知样式等
            @Override
            public Notification getNotification(Context context, UMessage msg) {
                Notification notification=registerCallBack.getNotification(context,msg);
                return notification!=null?notification:super.getNotification(context,msg);
            }
            ...
            public void dealWithCustomMessage(Context context, UMessage msg) {
                ...
                registerCallBack.dealWithCustomMessage(context, msg);
            }
        };
        ...
        UmengNotificationClickHandler notificationClickHandler = new UmengNotificationClickHandler() {
            ...
            public void openActivity(Context context, UMessage msg) {
                ...
                registerCallBack.openActivity(context, msg);
            ...
            public void launchApp(Context context, UMessage msg) {
                ...
                registerCallBack.launchApp(context,msg);
            ...
            public void dismissNotification(Context context, UMessage msg) {
                ...
                registerCallBack.dismissNotification(context, msg);
    ...
    {
        default  void onRegisterSuccess(String deviceToken){

        };
        void onFail(String errCode, String errDesc);
        ...
        void dismissNotification(Context context, UMessage msg);
    }

    public void setRegisterCallBack(IRegisterCallBack registerCallBack) {

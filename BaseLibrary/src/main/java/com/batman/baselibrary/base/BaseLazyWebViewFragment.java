...
import com.batman.baselibrary.widget.UIProgressWebView;


public class BaseLazyWebViewFragment extends LazyFragment {

    public UIProgressWebView mWebView;
...
//        webview.setWebChromeClient(new WebChromeClient());
    ...
    protected void initWebView() {
        mWebView = (UIProgressWebView) viewRoot.findViewById(R.id.web_view);
    }

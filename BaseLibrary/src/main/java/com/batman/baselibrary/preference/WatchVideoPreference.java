...
public class WatchVideoPreference implements SharedPreferences.OnSharedPreferenceChangeListener {


    public static final String KEY_PREFERENCE_NAME = "KEY_WATCH_VIDEO";

    //观看一圈时间
    public static final int RUN_DURATION_TIME_1 = 300;
    public static final int RUN_DURATION_TIME_2 = 600;
    public static final int RUN_DURATION_TIME_3 = 900;
    public static final int RUN_DURATION_TIME_4 = 1800;
    public static final int RUN_DURATION_TIME_5 = 1800;

    public int GOLD_1 = 10;
    public int GOLD_2 = 15;
    public int GOLD_3 = 20;
    public int GOLD_4 = 25;
    public int GOLD_5 = 30;


    public int GOLD_MUL_1 = 5;
    public int GOLD_MUL_2 = 5;
    public int GOLD_MUL_3 = 5;
    public int GOLD_MUL_4 = 5;
    public int GOLD_MUL_5 = 5;
    ...
    private static WatchVideoPreference mUserPres;

    private WatchVideoPreference() {
        getSharedPreferences().registerOnSharedPreferenceChangeListener(this);
        loadPrefs(getSharedPreferences());
    }

    public static WatchVideoPreference getInstance() {

        if (mUserPres == null) {
            mUserPres = new WatchVideoPreference();

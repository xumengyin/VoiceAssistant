...
public class Resource<T> {
     ...
     * @param token
     */
    public Resource(@NonNull Status status, @Nullable T data, @Nullable String message, String token) {
        this.status = status;
        this.data = data;
        this.message = message;
        this.mException = null;
    ...
    public static <T> Resource<T> success(@Nullable T data, String msg, String token) {
        return new Resource<>(SUCCESS, data, msg, token);
    }
